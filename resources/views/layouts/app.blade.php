    ...
    <div style="background: linear-gradient(90deg, #2196f3 0%, #21cbf3 100%); padding: 0;">
        <div class="container-fluid py-2 d-flex justify-content-between align-items-center" style="color: #fff;">
            <div class="d-flex align-items-center gap-3">
                <img src="{{ asset('images/logo.png') }}" alt="Kumsal Logo" style="height:64px; border-radius:50%; background:linear-gradient(135deg,#ffe082 60%,#fffde7 100%); box-shadow:0 4px 24px #2196f3a0,0 0 0 6px #fffde7; border:3px solid #ffd54f;">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('/urunler/sandalye/4-ayakli') }}">4 Ayaklı</a></li>
                                <li><a class="dropdown-item" href="{{ url('/urunler/sandalye/3-ayakli') }}">3 Ayaklı</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('/urunler/sandik/tek-sandik') }}">Tek Sandık</a></li>
                                <li><a class="dropdown-item" href="{{ url('/urunler/sandik/cift-sandik') }}">Çift Sandık</a></li>
                            </ul>
                        </li>
                    </ul>
